...
const game = {
  ...
  drawFinalPoints: function () {
    ...
    this.context.fillText("SCORE: " + points, 255, 180);
  },
...
function createObstacle() {
  ...
  height = Math.floor(Math.random() * (400 - 50 + 1) + 150);
  blastDistance = Math.floor(Math.random() * (400 - 150 + 1) + 100);
  
  game.myObstacles.push(
    new Component(75, 75, "./images/blast.png", x, height)
  );
  game.myObstacles.push(
    new Component(100, 100, "./images/blast.png", x, blastDistance)
  );
}
function updateGame() {
